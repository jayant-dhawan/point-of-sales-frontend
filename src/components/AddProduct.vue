<template lang="html">
  <div>
    <sui-button @click="toggle">Add Product</sui-button>
      ...
      <sui-modal-content scrolling>
        <sui-modal-description>
          ...
          <sui-form @submit.prevent>
            ...
            <sui-button floated="right" @click="addProduct()">Add</sui-button>
          </sui-form>
        </sui-modal-description>
      </sui-modal-content>
      <sui-modal-actions>
  ...
  methods: {
    ...
    async addProduct() {
      ...
      try {
        ...
        Swal.fire("SUCCESS", "Product added to database", "success");
